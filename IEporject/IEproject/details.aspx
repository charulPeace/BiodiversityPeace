<%@ Page Title="" Language="VB" MasterPageFile="~/H7/MasterPage.master" AutoEventWireup="false" CodeFile="details.aspx.vb" Inherits="H7_details" %>
	...
	<div class="main">
		<div class="details">
			...
			<div class="det_text">
				...
				<div class="read_more">
					 <a class="btn" href="details.aspx">read more</a>
				</div>
			</div>
			<div class="clear"></div>
		</div>
